...
Neonics_endpoints <- ggplot(Neonics) + geom_bar(aes(x=Endpoint)) + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
Neonics_endpoints
```
...
> Answer: The unique function gives us the total number of unique plots in the Litter dataset. The summary function gives us all the unique plots, but tallies the frequency of samples for each unique plot. 
