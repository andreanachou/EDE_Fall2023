...
#GaringerOzone.monthly$Date <- order(as.Date(GaringerOzone.monthly$Date, format="%Y-%m-%d"))
...
smk_Garinger_monthly <- smk.test(GaringerOzone.monthly.ts)
...
#subtract seasonal components from GaringerOzone decomposition by selecting for
#all values "," from columns 2:3
GaringerOzone.monthly_noseasonal <- 
  as.data.frame(Garinger_monthly_decomp$time.series[, 2:3])

GaringerOzone.monthly_noseasonal <-
  mutate(GaringerOzone.monthly_noseasonal, 
         Observed = GaringerOzone.monthly$Mean_Ozone,
         Date = GaringerOzone.monthly$Date)

#16

Garinger.monthly.noseasonal.ts <- ts(GaringerOzone.monthly_noseasonal$Observed,
                                     frequency=12, start=c(2010, 1))

Garinger.monthly.noseasonal.mk <- MannKendall(Garinger.monthly.noseasonal.ts)
