...
Plot_5_temp <- NTL_LTF %>% ggplot(aes(x=factor(NTL_LTF$month, levels=1:12, labels=month.abb), y=temperature_C, color=lakename)) +
  geom_boxplot() 
Plot_5_temp

Plot_5_TP <- NTL_LTF %>% ggplot(aes(x=factor(NTL_LTF$month, levels=1:12, labels=month.abb), y=tp_ug, color=lakename)) +
  geom_boxplot()
Plot_5_TP

Plot_5_TN <- NTL_LTF %>% ggplot(aes(x=factor(NTL_LTF$month, levels=1:12, labels=month.abb), y=tn_ug, color=lakename)) +
  geom_boxplot()
Plot_5_TN

combo_5 <- plot_grid(Plot_5_temp + theme(legend.position="none"), 
                    Plot_5_TP + theme(legend.position="none"), 
                    Plot_5_TN + theme(legend.position="none"), 
                    nrow=1, align = 'h')
combo_5
