...
```{r table, echo=FALSE}
epa_air <- cbind(c("Item", "Source", "Date", "Filename"), 
                 c("Value", "EPA Air Quality System (AQS)", 
                   "2018-2019", "EPAair_O3_PM25_NC1819_Processed.csv"))

#created a matrix by binding the two vector columns, assigned to object epa_air

knitr::kable(epa_air, align=c("r", "l"))
