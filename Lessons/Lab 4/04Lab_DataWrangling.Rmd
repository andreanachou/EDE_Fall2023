...
NTL.phys.data.Tuesday.1990.1999 <- filter(NTL.phys.data, lakename == "Tuesday Lake" & year4 %in% c(1990:1999))
...
Tuesday.1990.1999.July <- NTL.phys.data %>%
...
Tuesday.1990.1999.July.sum <- Tuesday.1990.1999.July %>%
  filter(depth == 0) %>%
  drop_na(temperature_C)
  summary(Tuesday.1990.1999.July$temperature_C)
